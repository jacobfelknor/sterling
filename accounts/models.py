...
class Account(models.Model):
    ...
    # self recursive relationship (essentially sub-account/categories. May be replaced by keywords below)
    ...
    keywords = models.ManyToManyField(Keyword, related_name="accounts")
